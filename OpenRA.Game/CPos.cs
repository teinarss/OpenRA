...
namespace OpenRA
{
	public struct CPos : IScriptBindable, ILuaAdditionBinding, ILuaSubtractionBinding, ILuaEqualityBinding, ILuaTableBinding, IEquatable<CPos>
	{
		...
		public CPos(short x, short y) { X = x; Y = y; Layer = 0; }
		public CPos(short x, short y, byte layer) { X = x; Y = y; Layer = layer; }
		public static readonly CPos Zero = new CPos(0, 0, 0);

		public static explicit operator CPos(int2 a) { return new CPos((short) a.X, (short) a.Y); }

		public static CPos operator +(CVec a, CPos b) { return new CPos((short) (a.X + b.X), (short) (a.Y + b.Y), b.Layer); }
		public static CPos operator +(CPos a, CVec b) { return new CPos((short) (a.X + b.X), (short) (a.Y + b.Y), a.Layer); }
		public static CPos operator -(CPos a, CVec b) { return new CPos((short) (a.X - b.X), (short) (a.Y - b.Y), a.Layer); }
		...
		public override int GetHashCode() { return X.GetHashCode() * 397 ^ Y.GetHashCode() ^ Layer.GetHashCode(); }
