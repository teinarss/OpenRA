				...
				case 0xFF:
					{
								...
								case TargetType.Terrain:
									{
										...
										{
											var cell = new CPos(r.ReadInt16(), r.ReadInt16(), r.ReadByte());
						...
						var extraLocation = flags.HasField(OrderFields.ExtraLocation) ? new CPos((short) r.ReadInt32(), (short) r.ReadInt32(), r.ReadByte()) : CPos.Zero;
